      ...
      {isMobile ? (
        ...
        <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={s.card}>
            ...
            <input type="text" placeholder="חיפוש..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} style={{ ...s.input, marginBottom: '12px' }} />
